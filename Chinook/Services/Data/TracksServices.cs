...
public class TracksServices : ITracksServices
{
    ...
    public async Task<List<PlaylistTrack>> GetTracks(ArtistDto artist, string currentUserId)
    {
        ...
        {
            throw new Exception("Error occurred while retrieving the tracks.", ex);
        }
    ...
    private async Task<Models.Playlist> CreateFavouitePlayList(string currentUserId)
    {
        try
        {
            using var dbContext = _dbFactory.CreateDbContext();
        ...
        {
            throw new Exception("Error occurred while creating the favorite playlist.", ex);
        }
    }
    ...
    public async Task UpdateFavoriteTrackStatus(long trackId, string currentUserId, bool isFavorite)
    {
        try
        {
            ...
            {
                // In anycase first time Dbsync issue happened
        ...
        {
            throw new Exception("Error occurred while updating the favorite track status.", ex);
        }
    ...
    public async Task RemoveTrackFromPlayList(long trackId, long playListId)
    {
        ...
        {
            throw new Exception("Error occurred while removing the track from the playlist.", ex);
        }
